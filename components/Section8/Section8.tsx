      ...
      <div className="section-content relative z-10 max-w-5xl mx-auto text-center px-4 sm:px-6 pt-[120px] sm:pt-[5%]">
        <div className="space-y-4 sm:space-y-8">
          ...
          <div className={`transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-300 leading-snug sm:leading-relaxed max-w-3xl mx-auto">
          ...
          <div className={`transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto">
              ...
              {/* Schedule Demo */}
              <div className="hidden sm:block group bg-black/30 backdrop-blur-sm rounded-xl border border-purple-500/20 p-4 sm:p-6 hover:border-purple-400/40 transition-all duration-300 hover:scale-105">
