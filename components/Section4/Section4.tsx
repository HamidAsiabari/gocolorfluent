...
const Section4 = memo(function Section4({
  ...
  return (
    <section 
      ...
      style={{
        transform: `translate3d(0, ${isClient ? (4 - currentSection - (isTransitioning ? (scrollDirection === 'down' ? transitionProgress : -transitionProgress) : 0)) * windowHeight : 0}px, 0)`,
        zIndex: 10,
        maxWidth: '100%',
    ...
    >
      ...
      <div className="section-background absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-20 right-20 w-36 h-36 border-2 border-violet-400/20 rounded-lg rotate-45 " />
        <div className="absolute bottom-28 left-16 w-28 h-28 border-2 border-purple-400/20 rounded-full " style={{ animationDuration: '18s' }} />
        ...
        {/* Circuit patterns */}
        <div className="absolute top-1/2 right-1/4 w-20 h-20 border-2 border-violet-400/30 rounded-full " style={{ animationDuration: '10s' }} />
        <div className="absolute bottom-1/3 right-1/3 w-16 h-16 border-2 border-purple-400/30 rounded-full " style={{ animationDuration: '14s' }} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 items-center md:items-center justify-between md:justify-center flex-grow md:flex-grow-0">
          ...
          <div className={`space-y-3 sm:space-y-6 lg:space-y-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'} order-1 lg:order-1`}>
            ...
            <div className="space-y-2 lg:space-y-4">
              <h2 className="text-[1.2rem] sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-violet-400 to-purple-400">Smart</span>
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-fuchsia-400"> Electronics</span>
              </h2>
            </div>
            ...
            <div className="space-y-6">
              <div className="hidden sm:block space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-purple-400 rounded-full  delay-200" />
                    <span className="text-gray-300">
                      <SimpleTextAnimation 
                  ...
                  <div className="flex items-center space-x-3">
                    <div className="w-2 h-2 bg-fuchsia-400 rounded-full  delay-400" />
                    <span className="text-gray-300">
                      <SimpleTextAnimation 
          ...
          <div className={`block transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'} order-2 lg:order-2`}>
            <div className="relative w-fit">
              ...
              <div className={`relative w-full h-[200px] sm:h-96 bg-gradient-to-br from-violet-900/30 to-fuchsia-900/30 rounded-2xl border border-violet-500/20 overflow-hidden transition-all duration-1000 ${isBlurred ? 'backdrop-blur-sm' : 'backdrop-blur-none'}`}>
              ...
              <div className="absolute -top-6 -right-6 w-12 h-12 border-2 border-violet-400/30 rounded-full " style={{ animationDuration: '8s' }} />
              <div className="absolute -bottom-6 -left-6 w-8 h-8 border-2 border-purple-400/30 rounded-full " style={{ animationDuration: '12s' }} />
            </div>
          </div>
        </div>
      </div>
