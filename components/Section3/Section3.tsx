...
export default function Section3({
  ...
  return (
    ...
    >
      ...
      {/* Section Indicator */}
      <div className="absolute top-6 left-6 bg-black/40 backdrop-blur-md rounded-xl px-4 py-2 border border-emerald-500/30 shadow-lg">
        <span className="text-emerald-400 text-sm font-mono tracking-wider">Section 3</span>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            <div className="relative">
              ...
              <div className="relative w-full h-96 bg-gradient-to-br from-emerald-900/30 to-cyan-900/30 rounded-2xl border border-emerald-500/20 backdrop-blur-sm overflow-hidden">
